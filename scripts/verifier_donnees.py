...
CERTIFICATIONS = (
    ...
    Certification(
        ...
        entete=(
            ...
            "# 5. LE SCHÉMA DE FINANCEMENT A CHANGÉ DEPUIS. Ces parts décrivent une",
            "#    subvention d'État versée AU régime. Depuis le 1er janvier 2025, la",
            "#    CNAV équilibre en dernier ressort les régimes fermés — SNCF, RATP,",
            "#    mines, SEITA, CNIEG, CRPCEN, Banque de France, entre autres (3° de",
            "#    l'article L. 134-3 CSS) — et l'État la compense par crédits",
            "#    budgétaires (8° de l'article L. 241-3), nets de la compensation",
            "#    démographique et des cotisations que la fermeture a portées au",
            "#    régime général et à l'Agirc-Arrco. Lu dans les projets annuels de",
            "#    performances du PLF 2026 (`pap_regimes_subventionnes.csv`) ; le",
            "#    classeur du COR, antérieur, ne le connaît pas, et le poste",
            "#    `subventions_equilibre` d'après 2025 est à lire comme « ce que le",
            "#    régime coûte à la solidarité nationale », par la CNAV ou par l'État.",
            "#",
            "# Ne pas modifier ces valeurs à la main : elles seraient écrasées",
            "# au prochain scripts/verifier_donnees.py --appliquer.",
        ),
    ...
    Certification(
        ...
        entete=(
            ...
            "#",
            "# UNE CAISSE PEUT MANQUER UNE ANNÉE, ET CE N'EST PAS UN OUBLI",
            "# ------------------------------------------------------------",
            "# La DREES ne publie pas toutes les caisses toutes les années : la",
            "# coordination RATP paraît en 2020, 2021, 2023 et 2024, et pas en",
            "# 2022. Le dépôt reconduit alors la dernière valeur connue, comme",
            "# il le fait partout ; mais la série se charge en `ponctuelle` et",
            "# non en escalier, si bien que l'année reconduite tombe au niveau",
            "# `estimee`. Une enquête n'est pas un barème : l'année absente",
            "# d'un barème n'a pas changé, celle d'une enquête n'a pas été",
            "# MESURÉE, et la dire certifiée prêterait au producteur un chiffre",
            "# qu'il n'a pas publié. Le niveau `certifiee` annoncé ci-dessus",
            "# vaut donc pour les années ÉCRITES, et pour elles seules.",
            "#",
            "# À QUOI CETTE SÉRIE SERT",
            "# ------------------------",
