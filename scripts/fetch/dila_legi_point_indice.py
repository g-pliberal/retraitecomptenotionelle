...
"""Point d'indice de la fonction publique, lu dans le décret qui le fixe.
    ...
    python scripts/fetch/dila_legi_point_indice.py               # une minute
    python scripts/fetch/dila_legi_point_indice.py --dump   # le dump global, 1,1 Go
