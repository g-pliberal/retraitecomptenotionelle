...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->795<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->4 487<!--/--> Ko bruts) et prend quelques dixièmes
...
<!--chiffre:tests()-->1833<!--/--> tests couvrent le chargement et la fiabilité des données, la
