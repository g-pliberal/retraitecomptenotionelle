...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->717<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->4 217<!--/--> Ko bruts) et prend quelques dixièmes
...
(<!--chiffre:poids(moteur/donnees.json)-->2 987<!--/--> Ko — les séries, les
...
<!--chiffre:entrees(tests/temoins/simulations.json:)-->489<!--/--> simulations complètes et
...
<!--chiffre:tests()-->1179<!--/--> tests couvrent le chargement et la fiabilité des données, la
