...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->764<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->4 365<!--/--> Ko bruts) et prend quelques dixièmes
...
(<!--chiffre:poids(moteur/donnees.json)-->2 996<!--/--> Ko — les séries, les
...
<!--chiffre:tests()-->1744<!--/--> tests couvrent le chargement et la fiabilité des données, la
