...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->798<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->4 495<!--/--> Ko bruts) et prend quelques dixièmes
...
<!--chiffre:tests()-->1842<!--/--> tests couvrent le chargement et la fiabilité des données, la
