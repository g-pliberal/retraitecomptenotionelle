...
chargement transfère 247 Ko compressés (1676 Ko brut) et prend quelques dixièmes
...
`index.html` charge deux choses : `moteur/donnees.json` (1676 Ko — les séries, les
...
moteur/                         ce que le navigateur charge, et rien d'autre
  donnees.json                  séries, tables, régimes et inventaire (1676 Ko, produit par script)
