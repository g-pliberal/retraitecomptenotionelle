...
`index.html` charge deux choses : `moteur/donnees.json` (622 Ko — les séries, les
tables de mortalité observées de 1899 à 2024, la pyramide des âges de 1962 à
2070, les 39 fiches de régime) et
...
# Les 25 statuts et les 39 régimes du catalogue
...
| Tous les régimes, actuels **et** disparus | 39 régimes : AGIRC, ARRCO, CANCAVA, ORGANIC, RSI, mines, SEITA, chemins de fer secondaires… |
...
| Tout le monde peut simuler | 25 statuts d'affiliation, cinq informations suffisent |
...
data/
  ...
  reference/
    ...
    regimes/                    39 fiches de régime + schéma + valeurs du point
...
moteur/                         ce que le navigateur charge, et rien d'autre
  donnees.json                  séries, tables et régimes (622 Ko, produit par script)
