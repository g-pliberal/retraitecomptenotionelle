...
| Portage vérifié, pas cru sur parole | Le site rejoue 249 simulations témoins figées depuis le modèle Python — chaque statut d’affiliation à quatre générations, née en 1925, 1935, 1955 et 1975, pour que les règles anciennes de chaque régime soient visitées autant que les récentes ; un test oblige ce balayage à couvrir tous les statuts |
