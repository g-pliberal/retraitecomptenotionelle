...
chargement transfère 175 Ko compressés (831 Ko brut) et prend quelques dixièmes
...
2070, les 48 fiches de régime) et
...
# Les 32 statuts et les 48 régimes du catalogue
...
| Tous les régimes, actuels **et** disparus | 48 régimes : AGIRC, ARRCO, CANCAVA, ORGANIC, RSI, mines, SEITA, chemins de fer secondaires… |
...
| Tout le monde peut simuler | 32 statuts d'affiliation, cinq informations suffisent |
...
data/
  ...
  reference/
    ...
    regimes/                    48 fiches de régime + schéma + valeurs du point
