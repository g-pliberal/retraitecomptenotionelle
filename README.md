...
<!--chiffre:entrees(tests/temoins/simulations.json:)-->503<!--/--> simulations complètes et
...
<!--chiffre:tests()-->2296<!--/--> tests couvrent le chargement et la fiabilité des données, la
