...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->792<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->4 479<!--/--> Ko bruts) et prend quelques dixièmes
...
(<!--chiffre:poids(moteur/donnees.json)-->3 039<!--/--> Ko — les séries, les
...
<!--chiffre:entrees(tests/temoins/pages.json:)-->46<!--/--> rendus de page, dans `tests/temoins/`.
...
<!--chiffre:tests()-->1824<!--/--> tests couvrent le chargement et la fiabilité des données, la
