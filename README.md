...
chargement transfère 170 Ko compressés (683 Ko brut) et prend quelques dixièmes
...
`index.html` charge deux choses : `moteur/donnees.json` (682 Ko — les séries, les
tables de mortalité observées de 1899 à 2024, la pyramide des âges de 1962 à
2070, les 44 fiches de régime) et
...
# Les 29 statuts et les 44 régimes du catalogue
...
| Tous les régimes, actuels **et** disparus | 44 régimes : AGIRC, ARRCO, CANCAVA, ORGANIC, RSI, mines, SEITA, chemins de fer secondaires… |
...
| Tout le monde peut simuler | 29 statuts d'affiliation, cinq informations suffisent |
...
data/
  ...
  reference/
    ...
    regimes/                    44 fiches de régime + schéma + valeurs du point
...
moteur/                         ce que le navigateur charge, et rien d'autre
  donnees.json                  séries, tables et régimes (682 Ko, produit par script)
