...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html - moteur/js/lecture-pdf.js - moteur/js/releve-lu.js)-->829<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html - moteur/js/lecture-pdf.js - moteur/js/releve-lu.js)-->4 597<!--/--> Ko bruts) et prend quelques dixièmes
...
<!--chiffre:entrees(tests/temoins/pages.json:)-->51<!--/--> rendus de page, dans `tests/temoins/`.
...
<!--chiffre:tests()-->2073<!--/--> tests couvrent le chargement et la fiabilité des données, la
