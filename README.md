...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html - moteur/js/lecture-pdf.js - moteur/js/releve-lu.js)-->936<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html - moteur/js/lecture-pdf.js - moteur/js/releve-lu.js)-->5 335<!--/--> Ko bruts) et prend quelques dixièmes
...
finit <!--chiffre:mesure(annees_equilibrees?scenario=6)-->45<!--/--> des années projetées à l'équilibre ou en excédent : <!--chiffre:mesure(solde?scenario=6&annee=2026)-->+0,55<!--/--> point de PIB en 2026 (<!--chiffre:mesure(solde?scenario=6&annee=2026&en=milliards)-->+17<!--/--> Md€ au PIB de 2025),
<!--chiffre:mesure(solde?scenario=6&annee=2050)-->+0,03<!--/--> en 2050 (<!--chiffre:mesure(solde?scenario=6&annee=2050&en=milliards)-->+1<!--/--> Md€), <!--chiffre:mesure(solde?scenario=6&annee=2070)-->+1,76<!--/--> en 2070 (<!--chiffre:mesure(solde?scenario=6&annee=2070&en=milliards)-->+52,8<!--/--> Md€). La plus juste
est celle du pic du déficit que la TVA comble, <!--chiffre:mesure(coefficient?scenario=6&quoi=annee_minimum)-->2048<!--/-->, et c'est elle qui fixe le
taux : celui qui la couvre, arrondi au dixième, <!--chiffre:mesure(parametre?nom=taux_tva_liberal)-->19,7<!--/--> %. L'âge légal de
<!--chiffre:mesure(parametre?nom=age_legal_liberal)-->65<!--/--> ans l'a fait baisser, en faisant cotiser plus longtemps ceux qu'il fait
attendre — et c'est un plafond : `docs/limites.md` dit ce que coûterait un
report qui ne trouverait pas d'emploi à tous. Ses excédents font en 2070 des
réserves, une dette négative de <!--chiffre:mesure(dette?scenario=6)-->-33<!--/--> % du PIB, <!--chiffre:mesure(dette?scenario=6&en=milliards)-->-1002<!--/--> Md€, contre une dette de <!--chiffre:mesure(dette?scenario=1)-->66<!--/--> % pour le
...
à taux unique de <!--chiffre:mesure(parametre?nom=taux_tva_liberal)-->19,7<!--/--> %** remplace les quatre taux d'aujourd'hui, et ce qu'elle
rapporte de plus, <!--chiffre:mesure(recette?quoi=tva&annee=2026)-->1,63<!--/--> points de PIB en 2026, <!--chiffre:mesure(recette?quoi=tva&annee=2026&en=milliards)-->49<!--/--> Md€ au PIB de 2025, paie
...
sous <!--chiffre:mesure(coefficient?scenario=6&quoi=minimum)-->1,00<!--/--> — au plus bas en <!--chiffre:mesure(coefficient?scenario=6&quoi=annee_minimum)-->2048<!--/-->, au pic du déficit que la TVA comble —
et atteint <!--chiffre:mesure(coefficient?scenario=6)-->1,214<!--/--> en 2070. Sans elle, ce solde moyen était négatif et plus bas que
...
<!--chiffre:tests()-->2366<!--/--> tests couvrent le chargement et la fiabilité des données, la
