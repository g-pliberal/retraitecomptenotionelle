...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->802<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->4 509<!--/--> Ko bruts) et prend quelques dixièmes
...
(<!--chiffre:poids(moteur/donnees.json)-->3 041<!--/--> Ko — les séries, les
...
<!--chiffre:tests()-->1849<!--/--> tests couvrent le chargement et la fiabilité des données, la
