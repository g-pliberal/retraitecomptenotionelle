...
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html)-->4 219<!--/--> Ko bruts) et prend quelques dixièmes
...
<!--chiffre:tests()-->1180<!--/--> tests couvrent le chargement et la fiabilité des données, la
