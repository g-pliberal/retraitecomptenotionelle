...
chargement transfère 252 Ko compressés (1735 Ko brut) et prend quelques dixièmes
...
`index.html` charge deux choses : `moteur/donnees.json` (1735 Ko — les séries, les
...
moteur/                         ce que le navigateur charge, et rien d'autre
  donnees.json                  séries, tables, régimes et inventaire (1735 Ko, produit par script)
