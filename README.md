...
chargement transfère <!--chiffre:poids_comprime(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html - moteur/js/lecture-pdf.js - moteur/js/releve-lu.js)-->831<!--/--> Ko compressés
(<!--chiffre:poids(moteur/donnees.json + moteur/style.css + moteur/js/*.js + index.html - moteur/js/lecture-pdf.js - moteur/js/releve-lu.js)-->4 601<!--/--> Ko bruts) et prend quelques dixièmes
...
<!--chiffre:tests()-->2077<!--/--> tests couvrent le chargement et la fiabilité des données, la
