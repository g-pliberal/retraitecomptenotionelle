...
class ContributionEtat(str, Enum):
    """Ce que le compte d'un agent de l'État reçoit de son employeur.

    Ne joue que là où la part patronale est portée au compte (``TOTALE`` :
