...
<!--chiffre:lignes(src/retraite_notionnelle/scenarios/actuel.py)-->4 867<!--/-->,
et « douze mille lignes » au portage, qui en fait
<!--chiffre:lignes(moteur/js/*.js)-->33 272<!--/--> ; le README annonçait un
...
- **les sections non déclarées**, aujourd'hui
  <!--chiffre:valeur(data/reference/prose/zones.yaml:cliquet.sections_a_declarer)-->6<!--/--> ;
