...
| Régime complémentaire des indépendants (`rci`) | non-salariés | depuis 2013 | ✅ modélisé | `artisan`, `commercant`, `gerant_debit_tabac`, `micro_entrepreneur` |  |
