...
`data/sources.yaml` recense les <!--chiffre:entrees(data/sources.yaml:institutions.*.jeux)-->164<!--/--> jeux de données des
<!--chiffre:entrees(data/sources.yaml:institutions)-->37<!--/--> institutions, avec pour chacun l'URL, le mode
