...
(<!--chiffre:lignes(src/retraite_notionnelle/scenarios/actuel.py)-->4 937<!--/--> lignes)
et dans le portage `moteur/js/` (<!--chiffre:lignes(moteur/js/*.js)-->33 362<!--/--> lignes), puis dans les
