...
export function carriereCasType(cas, simulateur, generation, ageLiquidation) {
...
/**
 * L'âge auquel ce cas type liquide, étant né en `generation` : le pilote le
 * fixe (`ageDeDepart`, dans `pilote.js`).
 */
